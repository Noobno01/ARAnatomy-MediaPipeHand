...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.ARStarterAssets
{
    ...
    {
        [SerializeField]
        [Tooltip("Cooldown time in seconds before another object can be spawned.")]
        private float spawnCooldown = 1.0f; // Adjust cooldown duration

        private bool canSpawn = true; // Allows spawning
        ...
        private System.Collections.IEnumerator SpawnCooldownRoutine()
        {
            canSpawn = false;
